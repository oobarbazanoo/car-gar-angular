...
export const AuthApiBaseUrl = new InjectionToken<string>('AuthApiBaseUrl');
...
export class AuthApi {
    ...
    constructor(@Inject(HttpClient) http: HttpClient, @Optional() @Inject(AuthApiBaseUrl) baseUrl?: string) {
        this.http = http;
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<SignupResponse>><any>_observableThrow(e);
                }
            } else
                return <Observable<SignupResponse>><any>_observableThrow(response_);
        }));
    }
    ...
    protected processSignup(response: HttpResponseBase): Observable<SignupResponse> {
        ...
        if (status === 200) {
            ...
            result200 = SignupResponse.fromJS(resultData200);
        ...
        return _observableOf<SignupResponse>(<any>null);
    }
